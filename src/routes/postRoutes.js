...
router.get("/", validateSchema(postSchema.listPost), requiredLogin, postController.index);
router.get("/:id", validateSchema(postSchema), requiredLogin, postController.show);
router.put("/:id", validateSchema(postSchema.updatePost), requiredLogin, postController.update);
